...
@if(isset($data))
    ...
    <div class="container">
     ...
     <!-- <div class="form-group">
        <label>Hosting Type<span class="red">*</span></label>
    ...
    <div class="tile">
        <div class="table-responsive cust-table-width">
            ...
            <div  class="d-flex justify-content-end mb-2 mr-4">
                <button class="btn btn-primary" data-toggle="modal" data-target="#myModal">Add More</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!-- <form onsubmit="get_location_assets()" method="POST" enctype="multipart/form-data"> -->
            {{ csrf_field() }}
         <!-- <div class="form-group">
            <label>Asset type<span class="red">*</span></label>
...
<div id="edit_modal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Assets Edit</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
        <div class="form-group">
