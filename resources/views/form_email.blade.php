...
<p>To help comply with D3GRC, we need you to complete an assessment form.<br>
Please click on the <strong>Complete Form</strong> button below to fill this assessment form before <span style="color:#f00">{{date('Y-m-d', strtotime($expiry_time))}}</span><strong></strong> <br>
&nbsp;</p>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica; font-size: 18px; padding: 18px;">
                                <a class="mcnButton " title="Complete Form" href="{{ url('/Forms/'.$user_form.'/'.$form_link_id) }}" target="_self" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Complete Form</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <em>Copyright © {{date('Y')}} {{$client_info->name}}, All rights reserved.<br>
