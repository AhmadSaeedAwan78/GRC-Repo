				...
				<div class="card">
					...
					<div class="card-body" id="org-form">
						...
						<div class="form-group row">
						        <!--
								<label class="col-sm-4 form-control-label">Administrator Name</label>
								<div class="col-sm-8">
							...
							<div class="line"></div>
								...
								<div class="col-sm-8">
									<input id="company" type="number" class="form-control" name="phone" value="{{ old('phone') }}" required autofocus> 
								</div>
							</div>
							<div class="line"></div>
                                                        <div class="form-group row">
								...
								<div class="col-sm-8">
									<input id="company" type="url" class="form-control" name="website" value="{{ old('website') }}" required autofocus> 
								</div>
							</div>
							...
							<div class="OrganizationUser">
								<div class="form-group row">
									<label class="col-sm-6 form-control-label">Logo</label>
									<div class="img_dlt">
										...
										<a style="margin-top: 20px; margin-left: 52px;" class="btn btn-primary" id="add_images" href="#">Browse image</a>
										<div class="size max-spec">Max Resolution 300 x 180</div>
										<div class="size max-spec">Max Size 1 MB</div>
									</div>		
								</div>
