					...
					<div class="row">
						...
						<div class="col-sm-6 col-md-4">
							...
							<div class="form-group">
								...
								<input id="name" type="text" class="form-control" name="website" value="{{ $user->website }}" required autofocus>
						...
						<div class="col-sm-6 col-md-4">
							...
							<div class="form-group">	
								...
								@if($user->image_name=="")
								<img id="blah" src="{{url('dummy.jpg')}}" style=" width: 200px; padding: 9px;" />
								@else
								<img id="blah" class="img-fluid" src="<?php echo url("img/$user->image_name");?>" name="profile_image" style="padding: 5px; width: 200px;">
								@endif
								</div>
