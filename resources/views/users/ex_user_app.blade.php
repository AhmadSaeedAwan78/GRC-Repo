...
<head><meta charset="gb18030">
  ...
  <link rel="icon" href="{{ url('public/image/favicon.ico')}}" type="image/png">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand topbar mb-4 static-top shadow" style="background-color: #4267b2;">

     <a  href="{{url('/')}}">

        <div class="">

          <img style="width: 197px; height: 30px; margin: 10px;" src="{{url('public/image')}}/{{DB::table('login_img_settings')->first()->image}}">
...
<!--               <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="{{ URL::to('/img/') }}">
      ...
      <footer class="sticky-footer bg-white">
        ...
        <div class="container my-auto">
          ...
          <div class="copyright text-center my-auto">
            ...
            <span>Copyright © D3GRC - Compliance Management System  {{ date('Y') }}</span>
